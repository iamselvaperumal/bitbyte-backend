...
router.get('/my-requests', authorize('employee', 'intern'), leaveController.getLeaveRequests); // Repurposed for self-history
...
router.post('/request', authorize('admin', 'employee', 'intern'), validate(schemas.leaveRequest), leaveController.createLeaveRequest);
